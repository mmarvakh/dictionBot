...
start_message = text(bold("Здравствуйте, {name}"),
               ...
               bold("Для того, чтобы узнать о доступных программах тренировки, воспользуйтесь командой /help"),
               sep="\n\n")
...
change_state_plan_message = text(bold("Был выбран план:\n"),
                    "{plan}\n",
...
MESSAGES = {
    ...
    'about' : about_message,
    'plans' : plans_message,
    'change_state' : change_state_plan_message,
